...
function createInfoWindowContent(response){
    return `<div>
        ...
        <div id="temperature">
            <h2>Temperature:</h2>
            Real: ${Math.round((response.main.temp - CELSIUS_ZERO) * 10) / 10} C
            <br>Feels like: ${Math.round((response.main.feels_like - CELSIUS_ZERO) * 10) / 10} C
            <br>Max: ${Math.round((response.main.temp_max - CELSIUS_ZERO) * 10) / 10} C
            <br>Min: ${Math.round((response.main.temp_min - CELSIUS_ZERO) * 10) / 10} C
        </div>
        <div id="weather">
